...
urlpatterns = [
    path(
        "account/confirm/<str:token>",
        SendVerifyUserApi.as_view(),
        name="confirm",
    ),
    path(
        "account/ResendVerify/",
        ResendVerifyUserApi.as_view(),
        name="ResendVerify",
    ),
    ...
    path(
        "account/SendResetPasswordEmail/",
        SendResetPasswordEmail.as_view(),
        name="SendResetPasswordEmail",
    ),
    path(
        "account/ResetPasword/<str:token>",
        ResetPassword.as_view(),
        name="ResetPassword",
    ),
    path("testSendEmail/", SendMailApi.as_view(), name="SendMail"),
    path(
        "registration/", RegistrationGAPIView.as_view(), name="registration"
    ),
